...
public class LC19_RemoveNth_Node_Clinic {
    ...
    public static void main(String[] args) {
        Solution sol = new LC19_RemoveNth_Node_Clinic().new Solution();

        // 測試案例
        // Input: head = [1,2,3,4,5], n = 2 → Output: [1,2,3,5]
        ListNode head1 = new LC19_RemoveNth_Node_Clinic().new ListNode(1);
        head1.next = new LC19_RemoveNth_Node_Clinic().new ListNode(2);
        head1.next.next = new LC19_RemoveNth_Node_Clinic().new ListNode(3);
        head1.next.next.next = new LC19_RemoveNth_Node_Clinic().new ListNode(4);
        head1.next.next.next.next = new LC19_RemoveNth_Node_Clinic().new ListNode(5);
        ...
        ListNode head2 = new LC19_RemoveNth_Node_Clinic().new ListNode(1);
        ...
        ListNode head3 = new LC19_RemoveNth_Node_Clinic().new ListNode(1);
        head3.next = new LC19_RemoveNth_Node_Clinic().new ListNode(2);
